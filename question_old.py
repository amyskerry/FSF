...
if int(qindex)==1:
	...
	timingvar='timing' + lastQ
       	sql='update FSF_rating set ' +qvar +' ="'+lastresponse+'" where rownum="'+formindex+'"'
       	cursor.execute(sql)	
...
print "<video width='512' height='384' id='myvideo' ><source src=%s type='video/mp4'></video>" % (moviename)
...
<br><br>Were these clips familiar to you? Please check the appropriate boxes if you had previously seen any of these clips.<br>
...
<input type="hidden" name="ratingvector" id="ratingvector" size=300 value="rating">
<input type="hidden" name="timevector" id="timevector" size=300 value="timing">
